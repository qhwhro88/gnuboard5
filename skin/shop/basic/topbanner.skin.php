...
// 커뮤니티 홈 상단 정적 배너 (캐러셀 없음, 최대 3개 병렬, 각 390×130)
?>
...
<style>
.home_top_banner { margin: 0 0 20px; }
.home_top_banner ul { display: flex; gap: 15px; margin: 0; padding: 0; list-style: none; }
.home_top_banner li { flex: 1 1 0; min-width: 0; }
...
@media (max-width: 480px) {
    .home_top_banner ul { flex-direction: column; gap: 10px; }
}
</style>